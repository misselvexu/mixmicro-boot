...
public class LoggingDataSourceRepository implements LoggingRepository {
  ...
  private static final String SQL_SELECT_SERVICE_DETAILS =
      "select lsd_id, lsd_service_id, lsd_service_ip, lsd_service_port,lsd_last_report_time,lsd_create_time from logging_service_details";
  /** Select ServiceDetails Id SQL */
  private static final String SQL_SELECT_SERVICE_DETAILS_ID =
      "select lsd_id from logging_service_details where lsd_service_id = ? and lsd_service_ip = ? and lsd_service_port = ? limit 1";
  /** Update ServiceDetail Last Report Time SQL */
  private static final String SQL_UPDATE_LAST_REPORT_SERVICE_DETAILS =
      "update logging_service_details set lsd_last_report_time = ? where lsd_id = ?";
  /** Select Trace Logs */
  private static final String SQL_SELECT_LOG =
      "select logging_request_logs.*, lsd_service_id,lsd_service_ip,lsd_service_port "
  ...
  private static final String SQL_INSERT_LOG =
      "insert into logging_request_logs (lrl_id, lrl_service_detail_id, lrl_trace_id, lrl_parent_span_id, lrl_span_id,\n"
  ...
  private static final String SQL_INSERT_GLOBAL_LOG =
      "insert into logging_global_logs (lgl_id, lgl_request_log_id, lgl_level, lgl_content, lgl_caller_class,\n"
  ...
  /**
   * Select All Service List {@link ServiceResponse}
   *
