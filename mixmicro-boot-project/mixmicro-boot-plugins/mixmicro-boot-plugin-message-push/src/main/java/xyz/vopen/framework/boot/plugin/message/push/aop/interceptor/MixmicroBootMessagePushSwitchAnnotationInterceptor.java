...
package xyz.vopen.framework.boot.plugin.message.push.aop.interceptor;
...
/**
 * Mixmicro Boot DataSource Advice use spring aop switch push implementation based on the {@link
 * MessagePushSwitch} configuration on the method
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 */
public class MixmicroBootMessagePushSwitchAnnotationInterceptor implements MethodInterceptor {
  ...
  public Object invoke(MethodInvocation invocation) throws Throwable {
    try {
      ...
      MessagePushSwitch messagePushSwitch =
          declaredMethod.getDeclaredAnnotation(MessagePushSwitch.class);
