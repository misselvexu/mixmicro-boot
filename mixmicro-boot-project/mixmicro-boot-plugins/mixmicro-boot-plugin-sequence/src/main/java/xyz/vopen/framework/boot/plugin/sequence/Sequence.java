package xyz.vopen.framework.boot.plugin.sequence;
 ...
 *
 * <p>特性： 1.支持自定义允许时间回拨的范围
 *
 * <p>2.解决跨毫秒起始值每次为0开始的情况（避免末尾必定为偶数，而不便于取余使用问题）
 *
 * <p>3.解决高并发场景中获取时间戳性能问题
 *
 * <p>4.支撑根据IP末尾数据作为workerId 5.时间回拨方案思考：1024个节点中分配10个点作为时间回拨序号（连续10次时间回拨的概率较小）
 *
...
public final class Sequence {
   ...
   */
  public Sequence(
      long dataCenterId, long workerId, boolean clock, long timeOffset, boolean randomSequence) {
