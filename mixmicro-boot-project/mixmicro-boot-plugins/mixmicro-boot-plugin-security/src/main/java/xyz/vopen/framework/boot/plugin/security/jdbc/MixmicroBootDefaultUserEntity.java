...
package xyz.vopen.framework.boot.plugin.security.jdbc;
...
/**
 * Created with Code-Builder. 表名: api_boot_user_info - ApiBoot默认的用户信息表 - 数据实体
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 */
@Data
public class MixmicroBootDefaultUserEntity {
  /** UI_ID - 用户编号，主键自增 */
