package xyz.vopen.framework.boot.plugin.oauth.translator;
...
/**
 * Override the default WebResponseExceptionTranslator Customize the error message format returned
 * by the authentication server
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 * @see org.springframework.security.oauth2.provider.error.DefaultWebResponseExceptionTranslator
 */
public class MixmicroBootWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
  /** Response in case of authentication error */
  private AuthorizationDeniedResponse authorizationDeniedResponse;

  public MixmicroBootWebResponseExceptionTranslator(
      AuthorizationDeniedResponse authorizationDeniedResponse) {
  ...
  public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
    ...
    Exception ase =
        (OAuth2Exception)
            this.throwableAnalyzer.getFirstThrowableOfType(OAuth2Exception.class, causeChain);
    if (ase != null) {
  ...
  private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e)
    ...
    MixmicroBootOAuth2Exception mixmicroBootOAuth2Exception =
        new MixmicroBootOAuth2Exception(e.getMessage(), e, authorizationDeniedResponse);
    ...
    ResponseEntity<OAuth2Exception> response =
        new ResponseEntity(mixmicroBootOAuth2Exception, headers, httpStatus);
    return response;
  }
