...
import static xyz.vopen.framework.boot.autoconfigure.logging.admin.ApiBootLoggingAdminProperties.API_BOOT_LOGGING_ADMIN_PREFIX;
...
public class ApiBootLoggingAdminProperties {
  ...
  public static final String API_BOOT_LOGGING_ADMIN_PREFIX = "mixmicro.boot.logging.admin";
