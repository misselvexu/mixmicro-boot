 ...
 */
@Configuration
@ConfigurationProperties(prefix = MIXMICRO_BOOT_OSS_PREFIX)
@Data
public class MixmicroBootOssProperties {
  /** oss 配置前缀 */
  public static final String MIXMICRO_BOOT_OSS_PREFIX = "mixmicro.boot.oss";
  /** 存储地域 */
