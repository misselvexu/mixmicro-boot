...
@Import({
  MixmicroBootRateLimiterRedisAutoConfiguration.class,
  MixmicroBootRateLimiterNacosConfigConfiguration.class
})
public class MixmicroBootRateLimiterAutoConfiguration {
  ...
  public MixmicroBootRateLimiterAutoConfiguration(
