...
@Import(MixmicroBootResourceRedisLoadAutoConfiguration.class)
public class MixmicroBootResourceLoadAutoConfiguration {
  /** Mixmicro Boot Resource Load Store Delegate */
  private MixmicroBootResourceStoreDelegate resourceStoreDelegate;

  public MixmicroBootResourceLoadAutoConfiguration(
