...
/**
 * Swagger2自动化配置 只有在设置api.boot.swagger.enable=true时或者在配置文件内不进行配置时（因为默认为true）才会自动化配置该类
...
@ConditionalOnProperty(
    prefix = API_BOOT_SWAGGER_PREFIX,
    name = "enable",
    havingValue = "true",
    matchIfMissing = true)
...
public class ApiBootSwaggerAutoConfiguration {
  ...
  public ApiBootSwaggerAutoConfiguration(
