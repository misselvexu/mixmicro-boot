...
import xyz.vopen.framework.boot.autoconfigure.enhance.ApiBootMyBatisEnhanceAutoConfiguration;
import xyz.vopen.framework.boot.autoconfigure.logging.admin.ui.ApiBootLoggingAdminUiAutoConfiguration;
...
public class ApiBootLoggingAdminAutoConfiguration {
  ...
  public ApiBootLoggingAdminAutoConfiguration(
      ApiBootLoggingAdminProperties apiBootLoggingAdminProperties) {
   ...
   *
   * @see ApiBootMyBatisEnhanceAutoConfiguration
   */
  @Configuration
