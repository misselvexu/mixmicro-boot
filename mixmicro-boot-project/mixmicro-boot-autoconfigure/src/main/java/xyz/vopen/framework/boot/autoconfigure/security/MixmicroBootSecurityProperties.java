...
@Data
@Configuration
@ConfigurationProperties(prefix = MIXMICRO_BOOT_SECURITY_PREFIX)
public class MixmicroBootSecurityProperties {
  /** 安全配置前缀 */
  public static final String MIXMICRO_BOOT_SECURITY_PREFIX = "mixmicro.boot.security";
  /** 默认的排除路径列表 */
  public static final String[] DEFAULT_IGNORE_URLS =
      new String[] {
        "/v2/api-docs",
        "/swagger-ui.html",
