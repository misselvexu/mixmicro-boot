...
import static xyz.vopen.framework.boot.autoconfigure.quartz.ApiBootQuartzProperties.API_BOOT_QUARTZ_PREFIX;
...
public class ApiBootQuartzProperties {
  /** quartz 配置前缀 */
  public static final String API_BOOT_QUARTZ_PREFIX = "mixmicro.boot.quartz";
