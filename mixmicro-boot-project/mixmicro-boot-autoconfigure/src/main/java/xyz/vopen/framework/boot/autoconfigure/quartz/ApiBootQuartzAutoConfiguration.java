...
public class ApiBootQuartzAutoConfiguration {
  ...
  public ApiBootQuartzAutoConfiguration(
  ...
  protected static class JdbcStoreTypeConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public ApiBootQuartzDataSourceInitializer apiBootQuartzDataSourceInitializer(
        DataSource dataSource,
        @QuartzDataSource ObjectProvider<DataSource> quartzDataSource,
    ...
    @Bean
    public static ApiBootQuartzAutoConfiguration.JdbcStoreTypeConfiguration
            .DataSourceInitializerSchedulerDependencyPostProcessor
        jobDataSourceInitializerSchedulerDependencyPostProcessor() {
      return new ApiBootQuartzAutoConfiguration.JdbcStoreTypeConfiguration
          .DataSourceInitializerSchedulerDependencyPostProcessor();
    }
