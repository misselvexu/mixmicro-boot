...
import static xyz.vopen.framework.boot.autoconfigure.pageable.ApiBootMyBatisPageableProperties.API_BOOT_PAGEABLE_PREFIX;
...
public class ApiBootMyBatisPageableProperties {
  ...
  public static final String API_BOOT_PAGEABLE_PREFIX = "mixmicro.boot.mybatis.pageable";
