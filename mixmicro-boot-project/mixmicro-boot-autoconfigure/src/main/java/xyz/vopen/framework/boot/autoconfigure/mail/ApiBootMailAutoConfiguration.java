...
@ConditionalOnProperty(
    prefix = ApiBootMailProperties.API_BOOT_MAIL_PREFIX,
...
public class ApiBootMailAutoConfiguration {
  ...
  public MixmicroBootMailService apiBootMailService(IAcsClient acsClient) {
    return new MixmicroBootAliYunMailService(
        acsClient,
        apiBootMailProperties.getAccountName(),
        apiBootMailProperties.isReplyToAddress(),
        apiBootMailProperties.getAddressType(),
        apiBootMailProperties.getFromAlias(),
        apiBootMailProperties.getTagName());
  }
  ...
  public IAcsClient acsClient() {
    IClientProfile profile =
        DefaultProfile.getProfile(
            apiBootMailProperties.getRegion().getValue(),
            apiBootMailProperties.getAccessKey(),
            apiBootMailProperties.getAccessSecret());
