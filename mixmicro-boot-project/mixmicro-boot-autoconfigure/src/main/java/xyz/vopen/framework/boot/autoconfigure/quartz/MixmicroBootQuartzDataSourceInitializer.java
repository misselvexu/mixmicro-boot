 ...
 */
public class MixmicroBootQuartzDataSourceInitializer extends AbstractDataSourceInitializer {
  private final MixmicroBootQuartzProperties properties;

  public MixmicroBootQuartzDataSourceInitializer(
      DataSource dataSource, ResourceLoader resourceLoader, MixmicroBootQuartzProperties properties) {
