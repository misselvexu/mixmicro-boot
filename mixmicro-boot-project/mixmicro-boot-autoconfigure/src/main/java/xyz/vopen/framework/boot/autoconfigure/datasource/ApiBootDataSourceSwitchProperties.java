...
import static xyz.vopen.framework.boot.autoconfigure.datasource.ApiBootDataSourceSwitchProperties.API_BOOT_DATASOURCE_SWITCH_PREFIX;
...
public class ApiBootDataSourceSwitchProperties {
  ...
  public static final String API_BOOT_DATASOURCE_SWITCH_PREFIX = "mixmicro.boot.datasource";
