...
import xyz.vopen.framework.boot.plugin.rate.limiter.centre.support.NacosRateLimiterConfigCentre;
...
public class MixmicroBootRateLimiterNacosConfigConfiguration {
  /** logger instance */
  static Logger logger = LoggerFactory.getLogger(MixmicroBootRateLimiterNacosConfigConfiguration.class);
  ...
  public MixmicroBootRateLimiterNacosConfigConfiguration(NacosConfigProperties nacosConfigProperties) {
    this.nacosConfigProperties = nacosConfigProperties;
    logger.info("Mixmicro Boot RateLimiter nacos config centre is instantiated.");
  }
