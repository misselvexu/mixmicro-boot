...
import static xyz.vopen.framework.boot.autoconfigure.mail.MixmicroBootMailProperties.MIXMICRO_BOOT_MAIL_PREFIX;
 ...
 */
@Configuration
@ConfigurationProperties(prefix = MIXMICRO_BOOT_MAIL_PREFIX)
@Data
public class MixmicroBootMailProperties {
  /** Mixmicro Boot mail properties config prefix */
  public static final String MIXMICRO_BOOT_MAIL_PREFIX = "mixmicro.boot.mail";
