...
public final class MappedStatementHelper {
  ...
  /** 缓存查询总数的mappedStatement key => statement Id value => mappedStatement */
  ...
  public static MappedStatement initCountStatement(MappedStatement statement) {
    ...
    MappedStatement.Builder builder =
        new MappedStatement.Builder(
            ...
            statement.getId() + COUNT_STATEMENT_SUFFIX,
    ...
    final ResultMap resultMap =
        new ResultMap.Builder(
                statement.getConfiguration(), statement.getId(), Long.class, new ArrayList())
            .build();
    builder.resultMaps(
        new ArrayList() {
          {
